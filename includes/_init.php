...
phpCAS::client(CAS_VERSION_2_0, CONFIG_CAS_HOST, CONFIG_CAS_PORT, CONFIG_CAS_CONTEXT, false);
phpCAS::setNoCasServerValidation();
*/

//L'utilisateur CAS n'est pas identique aux données de sessions
//On réinitialise la session
/*if (!empty($_SESSION['user']) &&
	!empty($_SESSION['user']['cas']) && (
		!phpCAS::checkAuthentication() ||
		$_SESSION['user']['cas'] != phpCAS::getUser())) {

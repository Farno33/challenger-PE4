...
class XLSXWriter
{
	...
	public function writeSheet(array $data, $sheet_name='', array $header_types=array(), $suppress_row = false)
	{
		$sheet_name = empty($sheet_name) ? 'Sheet1' : $sheet_name;
		$data = empty($data) ? array(array('')) : $data;
		if (!empty($header_types))
		{
			$this->writeSheetHeader($sheet_name, $header_types, $suppress_row);
		}

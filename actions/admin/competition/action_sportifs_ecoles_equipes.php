...
if (!empty($_GET['excel']) &&
	...
	$fichier = 'liste_sportifs_ecole_'.onlyLetters(utf8_decode(unsecure($sportifs[$_GET['excel']][0]['nom']))).'_equipes';
	...
	$fichier = 'liste_sportifs_ecoles_equipes';
...
require DIR.'templates/admin/competition/sportifs_ecoles_equipes.php';

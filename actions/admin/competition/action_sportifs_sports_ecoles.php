...
if (!empty($_GET['excel']) &&
	...
	$fichier = 'liste_sportifs_sport_'.onlyLetters(utf8_decode(unsecure($sportifs[$_GET['excel']][0]['sport']))).
		'_'.strip_tags(printSexe($sportifs[$_GET['excel']][0]['sexe'])).'_ecoles';
	...
	$fichier = 'liste_sportifs_sports_ecoles';
...
require DIR.'templates/admin/competition/sportifs_sports_ecoles.php';

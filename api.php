...
define('DEBUG_API', true && DEBUG_ACTIVE_ONLINE); // DEBUG_ACTIVE_ONLINE car les actions sont très sensibles
...
$modules = [
	...
	'participant' 	=> 'All actions associated to participants',
	'centralien' 	=> 'All actions associated to centraliens',

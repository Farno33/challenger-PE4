	...
	border-bottom: 20px solid #CCC;
			...
			<table>
				...
				<tbody>
					...
					<tr style="border-top:2px solid #000; height:50% !important" class="form clickme match-<?php echo $match['id']; ?>" data-id="<?php echo $match['id']; ?>" onclick="window.location.href = '<?php url('score/tournois/phase_'.$phase['id'].'?p=matchs&m='.$match['numero_elimination'].'&'.rand().'#m'.$match['numero_elimination']); ?>';">
					...
					<tr style="height:49% !important" class="form clickme match-<?php echo $match['id']; ?>" data-id="<?php echo $match['id']; ?>" onclick="window.location.href = '<?php url('score/tournois/phase_'.$phase['id'].'?p=matchs&m='.$match['numero_elimination'].'&'.rand().'#m'.$match['numero_elimination']); ?>';">
			...
			<div id="modal-match" class="modal big-modal">
					<form method="post" action="<?php url('score/tournois/phase_'.$id_phase.(!empty($_GET['p']) ? '?p='.$_GET['p'] : '').'#m'.$select['numero_elimination']); ?>">
						<fieldset>

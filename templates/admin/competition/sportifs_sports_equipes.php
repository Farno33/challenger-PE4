...
F|e.nom|eq.label|p.nom|p.prenom|p.sexe|p.licence|p.telephone
B|s.sport|s.sexe|e.nom|eq.label|p.nom|p.prenom';
...
?>
				...
				<nav class="subnav">
					<h2>
						Liste des Sportifs (par Sport) groupés par Equipe

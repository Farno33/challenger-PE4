...
?>
				...
				<nav class="subnav">
					<h2>
						Liste des Cameramans (Par Ecole)
				...
				foreach ($cameramans as $eid => $cameramans_ecole) {

				?>
				
				<h3><?php echo stripslashes($cameramans_ecole[0]['nom']); ?></h3>
				...
				<table class="table-small">
					<thead>
						<tr>
							<td colspan="5">
								<center>
								<?php if ($cameramans_ecole[0]['quota_cameraman'] !== null) { ?>
								Quota Cameramans : <b><?php echo $cameramans_ecole[0]['quota_cameraman']; ?></b>
								&nbsp; &nbsp; / &nbsp; &nbsp;
								<?php } ?>
								Cameramans :  <b><?php echo empty($cameramans_ecole[0]['pid']) ? 0 : count($cameramans_ecole); ?></b>
								</center>
							</td>
						</tr>
					...
					<tbody>
						...
						<?php if (empty($cameramans_ecole[0]['pid'])) { ?> 

						<tr class="vide">
							<td colspan="5">Aucun cameraman</td>
						</tr>

						<?php } else foreach ($cameramans_ecole as $cameraman) { ?>

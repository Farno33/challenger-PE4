...
?>
				...
				<?php if(!empty($_SESSION['user']['first'])) { ?>
					...
					<fieldset>
						...
						<label for="form-null">
							...
							<input class="disabled two_input" disabled type="text" value="<?php echo stripslashes($ecole['nom']).
								(empty($ecole['abreviation']) ? '' : ' ('.stripslashes($ecole['abreviation']).')'); ?>" />
						...
						<label for="form-adresse">
							<span>Adresse</span>
							<textarea <?php if (!empty($ecole['token'])) echo 'class="two_input" '; ?>name="adresse" id="form-adresse"><?php echo stripslashes($ecole['adresse']); ?></textarea>
							<?php if (!empty($ecole['token'])) { ?>
							<div class="two_input" style="height:100px; padding:0px; vertical-align:bottom; line-height:100px">
						...
						<label for="form-null">
							...
							<input class="two_input" type="text" placeholder="Code postal..." name="code_postal" id="form-code-postal" value="<?php echo stripslashes($ecole['code_postal']); ?>" />
							<input class="two_input" type="text" placeholder="Ville..." name="ville" id="form-ville" value="<?php echo stripslashes($ecole['ville']); ?>" />
						</label>
					
						<label for="form-null">
							<span>Email / Tel. Ecole</span>
							<input class="two_input" type="text" placeholder="Email..." name="email_ecole" id="form-email-ecole" value="<?php echo stripslashes($ecole['email_ecole']); ?>" />
							<input class="two_input" type="text" placeholder="Téléphone..." name="telephone_ecole" id="form-telephone-ecole" value="<?php echo stripslashes($ecole['telephone_ecole']); ?>" />
						</label>
					
						<label for="form-as-code">
							<span>Code(s) AS</span>
							<input type="text" disabled name="as_code" id="form-as-code" value="<?php echo stripslashes($ecole['as_code']); ?>" />
						</label>
					</fieldset>
